angular.module('app').controller('UserEditCtrl', ['$scope', '$http', '$location', 'Step', 'Block', 'Markdowns', 'Images', 'Videos', 'imgur', function ($scope, $http, $location, Step, Block, Markdowns, Images, Videos, imgur)
{

    $scope.loading = false;

    $scope.getUser = function(stepId) {
